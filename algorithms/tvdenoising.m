function x0 = tvdenoising(y0,lambda,iter)
%TVDENOISING Total variation (TV) denoising algorithm for one to four
%dimensional signals.
%   x0=TVDENOISING(y0,lambda,iter) returns the denoised signal by TV
%   denoising algorithm, where y0 is the original signal with noise.
%   See also GAP_TV, GAP_TV3D.
